...
colour=['darkorchid','violet','slateblue',"black"]
...
def undo(e):
    ...
    solids=False
    sheild=False
    canvas.itemconfig(ball,fill="darksalmon")
    canvas.delete(s)

def sheilds(e):
    global sheild,canvas,s
    sheild=True
    s=canvas.create_rectangle(0,490,700,500,fill="purple")
    print(sheild)
def solid(e):
    global solids,ball
...
bg = PhotoImage(file="blackkk.png")
...
brick1=canvas.create_rectangle(0, 40, 70, 60, fill=colour[0])
brick2=canvas.create_rectangle(70, 40, 140, 60, fill=colour[0])
brick3=canvas.create_rectangle(140, 20, 210, 40, fill=colour[1])
brick4=canvas.create_rectangle(210, 20, 280, 40, fill=colour[2])
brick5=canvas.create_rectangle(280, 20, 350, 40, fill=colour[1])
brick6=canvas.create_rectangle(350, 20, 420, 40, fill=colour[2])
brick7=canvas.create_rectangle(420, 20, 490, 40, fill=colour[1])
brick8=canvas.create_rectangle(490, 20, 560, 40, fill=colour[2])
brick9=canvas.create_rectangle(560, 40, 630, 60, fill=colour[0])
...
img = PhotoImage(file="paddlepic.png")
...
ball = canvas.create_oval(30, 150, 50, 170, fill="darksalmon")
xvelocity = 2
yvelocity = 2
